                        ...
                        <li>
                            ...
                            <a href="">
                                <div class="logo">
                                    ...
                                    <img src="{{asset('img/logo2.png')}}" style="width: 30px; height: 30px;">
                                </div>
                                <h1 class="brand-text">Newage Drive</h1>
                            </a>
                            <!-- END LOGO -->
                        </li>
                    </ul>
                            ...
                            <ul class="navbar-nav nav-right">
                                ...
                                <li class="nav-item dropdown dropdown-menu-lg">
                                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                        <img src="{{asset('img/avatars/default-user.png')}}" class="w-35 rounded-circle" alt="Albert Einstein">
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                                        <div class="dropdown-header pb-3">
                                            <div class="media d-user">
                                                <img class="align-self-center mr-3 w-40 rounded-circle" src="{{asset('img/avatars/default-user.png')}}" alt="{{Auth::user()->first_name}}">
                                        ...
                                        <a class="dropdown-item" href="/settings"><i class="icon dripicons-gear"></i> Account Settings </a>
                                        <div class="dropdown-divider"></div>
                                        {{--<a class="dropdown-item" href="#"><i class="icon dripicons-lock"></i> Lock Account</a>--}}
                                        <a class="dropdown-item" href="/logout"><i class="icon dripicons-lock-open"></i> Sign Out</a>
                                    </div>
                                </li>
                                {{--<li class="nav-item">
        ...
        <div class="container">
            ...
            <nav class="main-menu">
                <ul class="nav metismenu">
                    ...
                    <li>
                        <a class="has-arrow" href="{{route('dashboard')}}" aria-expanded="false"><i class="fa fa-dashboard"></i><span class="hide-menu">Dashboard</span></a>
                    </li>
                    <li>
                        <a class="has-arrow" href="{{route('allfiles')}}" aria-expanded="false"><i class="fa fa-file"></i><span class="hide-menu">All Files</span></a>

                    </li>
                    @if(Auth::user()->role == 'Creator')
                        <li>
                            <a class="has-arrow" href="{{route('createUser')}}" aria-expanded="false"><i class="fa fa-user"></i><span class="hide-menu">Add User</span></a>

                        </li>
                    @endif
                    {{--<li>
                        <a class="has-arrow" href="#" aria-expanded="false"><i class="icon dripicons-view-thumb"></i><span class="hide-menu">Menu</span></a>
